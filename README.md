...
- Timestamp: `2022-06-18 04:38`
- Build ID: `b7da183d-fbeb-4b26-8d46-1ac9b0b39dfb`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b7da183d-fbeb-4b26-8d46-1ac9b0b39dfb.git
$ cd b7da183d-fbeb-4b26-8d46-1ac9b0b39dfb
```
